...
export default function ChallengedReviewsSection() {
    ...
    const [getReviews, { data: reviewsData, fullRes: reviewsFullData, loading: reviewsLoading }] = useApi({ cache: "challenged-reviews", fullRes: true });
    ...
    const handleSubmitReview = async () => {
        ...
        try {
            const payload = {
                ...
                feedback: feedback,
                category_id: reviewAction === "deny" ? selectedCategory : selectedReview.self_declared_category || undefined
            };
            ...
            <div className="bg-white shadow rounded-lg overflow-hidden">
                {reviewsLoading ? (
                    ...
                    <div className="p-8 text-center text-gray-500">
                        No {statusFilter} records found for challenged reviews.
                    </div>
                ) : (
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {reviewAction === "approve"
                                ? "Are you sure you want to approve the user's category selection?"
